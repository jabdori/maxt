...
pub use adapters::{
    ...
    HyperliquidBookLevel, HyperliquidCandleSnapshot, HyperliquidDailyVolume,
    HyperliquidEvmContract, HyperliquidFundingHistoryEntry, HyperliquidL2Book, HyperliquidMidPrice,
