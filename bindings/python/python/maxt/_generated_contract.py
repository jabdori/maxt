...
PROVIDER_METHODS = {
    "upbit": ("region", "order_books", "order_books_at_level", "tickers", "tickers_by_quote", "year_candles", "orderbook_instruments", "market_events", "test_order", "deposit_info",),
    "bithumb": ("market_warnings", "market_alerts", "notices", "transfer_fees", "api_keys", "pending_orders",),
